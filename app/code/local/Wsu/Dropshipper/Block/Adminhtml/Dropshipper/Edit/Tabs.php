...
class Wsu_Dropshipper_Block_Adminhtml_Dropshipper_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
  ...
  {
      return $this->getLayout()->createBlock('wsu_dropshipper/adminhtml_dropshipper_edit_tab_ajax_serializer')
  ...
  protected function getOutputBlock()
  {
    if(Mage::registry('dropshipper_data')->getDshipper_id()){ 
        ...
        $gridBlock = $this->getLayout()->createBlock('wsu_dropshipper/adminhtml_dropshipper_edit_tab_product')
